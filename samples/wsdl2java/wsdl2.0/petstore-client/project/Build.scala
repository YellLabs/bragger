...
object ApplicationBuild extends Build {
	...
	lazy val root = play.Project(appName, appVersion, appDependencies).settings(
		...
		braggerClients in braggerGenerate := Seq(
			Api("http://localhost:9000/api-docs.wsdl/pet"  , "com.hibu.apis.petstore.clients.pet"),
			Api("http://localhost:9000/api-docs.wsdl/user" , "com.hibu.apis.petstore.clients.user"),
			Api("http://localhost:9000/api-docs.wsdl/store", "com.hibu.apis.petstore.clients.store")
		),
