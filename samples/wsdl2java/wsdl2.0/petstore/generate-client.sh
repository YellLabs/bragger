...
wsdl2java.sh --wsdl-version 2.0 --databinding-method jaxbri --package com.hibu.api.petservice --serverside-interface --unpack-classes --test-case --over-ride -uri petstore.wsdl
